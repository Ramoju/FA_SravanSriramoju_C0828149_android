...
public class PlacesRVItemTouchHelper extends ItemTouchHelper.SimpleCallback{

    private PlacesRVAdapter adapter;
    public PlacesRVItemTouchHelper(PlacesRVAdapter adapter) {
